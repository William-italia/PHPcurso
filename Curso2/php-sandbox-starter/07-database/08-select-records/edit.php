<?php
  ...
  $post = singlePost('posts', 'id', $_GET['id']);
?>
    ...
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
      ...
      <form method="post" action="update_post.php">
        ...
        <div class="mb-6">
          ...
          <textarea id="body" name="body" placeholder="Enter post body" class="w-full px-4 py-2 border rounded focus:ring focus:ring-blue-300 focus:outline-none h-[300px]"><?=$post->body?></textarea>
        </div>
        <div class="flex items-center justify-between">
          <button type="submit" name="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 focus:outline-none">
            <a href="update_post.php">Submit</a>
          </button>
