    ...
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
      ...
      <form method="post">
        ...
        <div class="mb-6">
          ...
          <textarea id="body" name="body" placeholder="Enter post body" class="w-full h-[300px] px-4 py-2 border rounded focus:ring focus:ring-blue-300 focus:outline-none"><?= $post['body']?></textarea>
        </div>
        <div class="flex items-center justify-between">
          <button type="submit" name="PUT" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 focus:outline-none">
            Atualizar
          </button>
